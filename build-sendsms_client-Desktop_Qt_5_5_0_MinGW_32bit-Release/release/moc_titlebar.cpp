...
#include "../../sendsms_client/titlebar.h"
...
QT_MOC_LITERAL(1, 9, 10), // "moveSignal"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 9) // "posChange"

    },
    "TitleBar\0moveSignal\0\0posChange"
};
...
void TitleBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->moveSignal((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (TitleBar::*_t)(QPoint );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TitleBar::moveSignal)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void TitleBar::moveSignal(QPoint _t1)
{
